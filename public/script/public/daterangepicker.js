...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '<button class="' + this.applyClass + ' deleteBtn">' + this.locale.deleteLabel + '</button>&nbsp;' +
        ...
        this.container.find('.ranges')
            ...
            .on('click', 'button.deleteBtn',function(){
                _self.element.find('span').text('请选择日期范围');
            })
            .on('click', 'button.cancelBtn,button.deleteBtn', $.proxy(this.clickCancel, this))
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            if (!minDate || minDate.isBefore(calendar[1][1])) {
                html += '<th class="prev available"><i class="icon-arrow-left entypo-left-open-big"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if (!maxDate || maxDate.isAfter(calendar[1][1])) {
                html += '<th class="next available"><i class="icon-arrow-right entypo-right-open-big"></i></th>';
            } else {
                html += '<th></th>';
            }
