...
class Location
{
	 ...
	 * @var array
	 */
	protected static $headers = array(301=>"HTTP/1.1 301 Moved Permanently", 302=>"HTTP/1.1 302 Found", 
			303=>"HTTP/1.1 303 See Other", 307=>"HTTP/1.1 307 Temporary Redirect");
